...
f=open(gcg.get_filepath(dir_='D:/MyBox/Github/pycnc/pycnc/examples',
                        filename='A_ExamplePlate_x1_y1_drill3.0_s7000'),
       'w')
...
f=open(gcg.get_filepath(dir_='D:/MyBox/Github/pycnc/pycnc/examples',
                        filename='B_ExamplePlate_x1_y1_mill6.0_s16000'),
       'w')

f.write(gcg.start_gcode())


f.write(gcg.square_pocket(0.0,
                         0.0,
                         25.1,
                         25.1,
                         TOOL_DIAMETER,
...
f.write(gcg.rectangle_rounded_corners(0.0,
                                     0.0,
                                     50.0,
                                     50.0,
                                     3.0, # corner radius
